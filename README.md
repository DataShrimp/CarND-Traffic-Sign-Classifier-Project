...
[image2]: ./tests/grayscale.jpg "Grayscaling"
...
For the first image, the model is relatively sure that this is a stop sign (probability of xxx), and the image does contain a stop sign. The top five weights were
...
For the second image, the model is relatively sure that this is a xxx sign (probability of xxx), and the image does contain a xxx sign. The top five weights were
...
For the third image, the model is relatively sure that this is a xxx sign (probability of xxx), and the image does contain a xxx sign. The top five weights were
...
For the fourth image, the model is relatively sure that this is a xxx sign (probability of xxx), and the image does contain a xxx sign. The top five weights were
...
For the fifth image, the model is relatively sure that this is a xxx sign (probability of xxx), and the image does contain a xxx sign. The top five weights were
